...
export const LAB_PROJECTS: LabProjectBase[] = [
  {
    ...
    links: [
      { label: "GitHub", href: "https://github.com/CristinaFores/design-context-bridge" },
      { label: "npm", href: "https://www.npmjs.com/package/design-context-bridge" },
    ],
    techBadges: ["TypeScript", "MCP", "Claude Code", "Node ≥ 18", "MIT License", "Cursor", "Windsurf", "VS Code", "OpenCode"],
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Chrome Web Store", href: "https://chromewebstore.google.com/detail/pakdegbkjgibdjkpdniabdocffiejolo" },
    ],
    techBadges: ["Chrome MV3", "React 18", "Whisper", "Google Translate", "MIT License", "Web Speech API"],
